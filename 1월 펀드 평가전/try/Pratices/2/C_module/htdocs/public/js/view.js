export default class View {
    ...
    investModal(e) {
        ...
        //     console.log(  $("#insert-modal").find('canvas')[0]);
        ...
        // $('.close_btn').on('hidden.bs.modal', function () {
        //     console.log("!");
        //     console.log('modal close');
        //   $(this).find('form')[0].reset()
        // });

        document.querySelector(".insert_btn").addEventListener("click", e => {
            if(price == "" || name == "" || !name.checkValidity() || !price.checkValidity()) {
                this.app.toast();
            } else {
                e.preventDefault();
